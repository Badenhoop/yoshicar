...
HardwareInterface::HardwareInterface()
{
  ...
  // rear wheel state
  hardware_interface::JointStateHandle rearWheelStateHandle{ rearWheelJointName, &rearWheelPosition, &rearWheelVelocity,
                                                             &rearWheelEffort };
  jointStateInterface.registerHandle(rearWheelStateHandle);
  // rear wheel command
  hardware_interface::JointHandle rearWheelCommandHandle{ rearWheelStateHandle, &rearWheelCommand };
  velocityJointInterface.registerHandle(rearWheelCommandHandle);

  const std::string frontSteerJointName{ "front_steer_joint" };
  // front steer state
  hardware_interface::JointStateHandle frontSteerStateHandle{ frontSteerJointName, &frontSteerPosition,
                                                              &frontSteerVelocity, &frontSteerEffort };
  jointStateInterface.registerHandle(frontSteerStateHandle);
  // front steer command
  hardware_interface::JointHandle frontSteerCommandHandle{ frontSteerStateHandle, &rearWheelCommand };
...
double HardwareInterface::convertTransRotVelToSteeringAngle(double translationalVelocity, double rotationalVelocity)
{
